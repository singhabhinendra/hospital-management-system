...
export default function FeaturesPage() {
  ...
  // Memoize features data to prevent re-creation on each render
  ...
  ], []) // Empty dependency array since features data is static

  // Memoize navigation handlers
  const handleSignUp = useMemo(() => () => router.push('/signup'), [router])
  const handleLearnMore = useMemo(() => () => router.push('/'), [router])
  const handleHomeClick = useMemo(() => () => router.push('/'), [router])
